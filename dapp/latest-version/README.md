...
This folder contains the current Stables MiniDapp release (`Stables_v00.00.02.mds.zip` or the version matching `APP_BUILD_VERSION`) for node installs.
...
Current published build: **v00.00.02** — `Stables_v00.00.02.mds.zip` in this folder.
