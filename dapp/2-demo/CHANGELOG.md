...
### [Unreleased] — v0.0.0.2.0 (demo dev line, in progress)

Open development line after the first public demo drop (`0.0.0.1.0`). `dapp.conf` version and `APP_BUILD_VERSION` are now `0.0.0.2.0`; the public download stays on the published `0.0.0.1.0` package until a `0.0.0.2.0` zip is built and shipped.
