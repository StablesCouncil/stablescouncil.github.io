  ...
  window.updateWelcomeLanguage = function () {
    ...
    if (elShowcaseIntroBody) {
      ...
      const versionLabel = rawVersion && rawVersion !== 'unknown'
        ...
        : 'unknown';
      const repoUrl = String(cfg.MDS_ZIP_URL || 'https://raw.githubusercontent.com/StablesCouncil/stablescouncil.github.io/main/dapp/latest-version/Stables_v0.0.0.3.45.mds.zip').trim();
