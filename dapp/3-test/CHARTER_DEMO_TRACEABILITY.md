...
| **Floating burn payout** | Honest when BR &lt; 1 | Clear user copy, no “always $1” lie |
...
| **Oracle mint gate** | Mint can gate; burn continues | Separate messaging for mint vs burn |
...
| Preserve invariant boundaries | Never imply x402 can bypass mint/burn/solvency/oracle constraints |
...
|------|------------------|
| Multi-source, median, smoothing, integrity | Short academy or tooltip text; **mint vs burn** distinction |
...
- **Preferred route module:** `1_development/stream_1_app/website/dapp/2-demo/assets/routes/protocol.js`
  ...
  - Include disclaimer:
    ...
    - no bypass of mint/burn/solvency/oracle rules.
