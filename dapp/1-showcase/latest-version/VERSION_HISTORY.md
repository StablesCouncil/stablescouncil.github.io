...
**Public display style:** current showcase package is **`v0.0.0.0.3`**. Internal app config keeps **`v00.00.00.00.03`** for canonical comparisons. Full explanation: [MINIDAPP_VERSIONING.md](../../MINIDAPP_VERSIONING.md).

| Version | Internal label | Stage | Published on | Package | Main developments | Author | Commit |
|---|---|---|---|---|---|---|---|
| `v0.0.0.0.3` | **`v00.00.00.00.03`** | showcase | 2026-04-09 | **`Stables_v0.0.0.0.3.mds.zip`** | Third showcase drop: five-segment **SS=03**, Mint xWiniwa chart reliability (fetch/MDS/synthetic fallback), active Pages **`dapp/`** aligned | `StablesCouncilExec` | *(set on push)* |
...
**Note (2026-04-09):** **`Stables_v00.00.02.mds.zip`** was moved out of **`latest-version/`** when **`Stables_v0.0.0.0.3.mds.zip`** became current (later **2026-04-16:** that and other historical zips consolidated into **`3_archive/.../task_archived_dapp_showcase_previous_mds_2026-04-16/`**).
