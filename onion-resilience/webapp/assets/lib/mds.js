...
function MDS_RPC_cmd(command, callback){
	if(typeof window !== "undefined" && typeof window.stablesGetRpcConfig === "function" && typeof window.stablesRpcSendCommand === "function"){
		var livecfg = window.stablesGetRpcConfig();
		if(livecfg && livecfg.url){
			window.stablesRpcSendCommand(command)
...
var MDS = {
	...
	cmd : function(command, callback){
		...
		if(typeof window !== "undefined"
			&& ((window.__STABLES_RPC_MODE && window.__STABLES_RPC_MODE.url)
				|| (typeof window.stablesGetRpcConfig === "function" && window.stablesGetRpcConfig()))){
