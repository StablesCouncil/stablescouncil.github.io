...
window.STABLES_CONFIG = {
  ...
  // Vault V2 lanes (XWINIWA_VAULT_V2_SAME_BLOCK_DESIGN.md): which registry entry the app treats as the
  // lane vault. Empty = the registry's own xwiniwa_vault_v2, which is absent until the founder seeds
  // the live V2 from the Cold ceremony, so today nothing changes. The proven mainnet dust-proof is
  ...
  DEMO_FEEDBACK_ROADMAP: {
    summary:
      'Test v0.0.11.88 includes the on-chain Winiwa faucet, xWiniwa mint and burn at par, and Winiwa/xWiniwa send and receive. Both are valueless test tokens. This update improves vault coordination, wallet proofs and app startup.',
    nowReview:
      'Winiwa faucet, xWiniwa mint and burn at par, transfers, wallet balances and Activity, startup readiness, recovery and four-platform consistency',
    comingSoon:
      'Further cold-start and payment timing measurements, battery measurements and multi-wallet testing',
    nextModules:
      'Stablecoins, trading, Coverage Funds and merchant business tools remain deferred from this test release',
    footnote:
